  ...
  <div class="panel-main">
    <div class="views">
      ...
      <div>
        ...
        <ElButton @click="onNewGame" size="small" type="primary"
          >新游戏</ElButton
        >

        得分：{{ score }} 等级：{{ level }} 速度：{{ speed }}
        <!-- <ElButton @click="onUp" size="small" type="primary">上</ElButton> -->
        <!-- <ElButton @click="onDown" size="small" type="primary">下</ElButton>
        <ElButton @click="onLeft" size="small" type="primary">左</ElButton>
        <ElButton @click="onRight" size="small" type="primary">右</ElButton>

        <ElButton @click="onRotate" size="small" type="primary">旋转</ElButton> -->
      </div>
    </div>
  </div>
</template>
...
const isInView = (component: any, pointX: any, pointY: any) => {
  ...
  return items.every((item) => {
    ...
    return (
      left >= 0 && left <= maxWidth.value && top >= 0 && top <= maxHeight.value
    );
  });
};
...
const createView = () => {
  ...
  const status = isCollision(
    component,
    defaultLeft.value - Math.floor(component.width * 0.5),
    0
  );
...
const onAddView = () => {
  ...
  config.workComponent.left =
    defaultLeft.value - Math.floor(config.workComponent.width * 0.5);
